...
--FILIAL PR
-- DEVELOPER.SEGURADORA_PR definition

CREATE TABLE "DEVELOPER"."SEGURADORA_PR"
(	"PK_SEGURADORA" NUMBER(*,0),
"NM_SEGURADORA" VARCHAR2(100),
"CIDADE" VARCHAR2(100),
"ESTADO" VARCHAR2(100),
"PK_MATRIZ" NUMBER(*,0),
CONSTRAINT "SEGURADORA_PR_PK" PRIMARY KEY ("PK_SEGURADORA")
USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS"  ENABLE
...
CREATE UNIQUE INDEX "DEVELOPER"."SEGURADORA_PR_PK" ON "DEVELOPER"."SEGURADORA_PR" ("PK_SEGURADORA")
PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS" ;


-- DEVELOPER.SEGURADORA_PR foreign keys

ALTER TABLE "DEVELOPER"."SEGURADORA_PR" ADD CONSTRAINT "FK_MATRIZ_PR" FOREIGN KEY ("PK_MATRIZ")
REFERENCES "DEVELOPER"."MATRIZ" ("PK_MATRIZ") ENABLE;

--FILIAL SP
-- DEVELOPER.SEGURADORA_SP definition

CREATE TABLE "DEVELOPER"."SEGURADORA_SP"
(	"PK_SEGURADORA" NUMBER(*,0),
"NM_SEGURADORA" VARCHAR2(100),
"CIDADE" VARCHAR2(100),
"ESTADO" VARCHAR2(100),
"PK_MATRIZ" NUMBER(*,0),
CONSTRAINT "SEGURADORA_SP_PK" PRIMARY KEY ("PK_SEGURADORA")
USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS"  ENABLE
) SEGMENT CREATION DEFERRED
PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255
...
CREATE UNIQUE INDEX "DEVELOPER"."SEGURADORA_SP_PK" ON "DEVELOPER"."SEGURADORA_SP" ("PK_SEGURADORA")
PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS" ;


-- DEVELOPER.SEGURADORA_SP foreign keys

ALTER TABLE "DEVELOPER"."SEGURADORA_SP" ADD CONSTRAINT "FK_MATRIZ_SP" FOREIGN KEY ("PK_MATRIZ")
REFERENCES "DEVELOPER"."MATRIZ" ("PK_MATRIZ") ENABLE;

--FILIAL RS
-- DEVELOPER.SEGURADORA_RS definition

CREATE TABLE "DEVELOPER"."SEGURADORA_RS"
(	"PK_SEGURADORA" NUMBER(*,0),
"NM_SEGURADORA" VARCHAR2(100),
"CIDADE" VARCHAR2(100),
"ESTADO" VARCHAR2(100),
"PK_MATRIZ" NUMBER(*,0),
CONSTRAINT "SEGURADORA_RS_PK" PRIMARY KEY ("PK_SEGURADORA")
USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS"  ENABLE
) SEGMENT CREATION DEFERRED
PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255
...
CREATE UNIQUE INDEX "DEVELOPER"."SEGURADORA_RS_PK" ON "DEVELOPER"."SEGURADORA_RS" ("PK_SEGURADORA")
PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS" ;


-- DEVELOPER.SEGURADORA_RS foreign keys

ALTER TABLE "DEVELOPER"."SEGURADORA_RS" ADD CONSTRAINT "FK_MATRIZ_RS" FOREIGN KEY ("PK_MATRIZ")
REFERENCES "DEVELOPER"."MATRIZ" ("PK_MATRIZ") ENABLE;

-- FILIAL RJ
-- DEVELOPER.SEGURADORA_RJ definition

CREATE TABLE "DEVELOPER"."SEGURADORA_RJ"
(	"PK_SEGURADORA" NUMBER(*,0),
"NM_SEGURADORA" VARCHAR2(100),
"CIDADE" VARCHAR2(100),
"ESTADO" VARCHAR2(100),
"PK_MATRIZ" NUMBER(*,0),
CONSTRAINT "SEGURADORA_RJ_PK" PRIMARY KEY ("PK_SEGURADORA")
USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS"  ENABLE
) SEGMENT CREATION DEFERRED
PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255
...
CREATE UNIQUE INDEX "DEVELOPER"."SEGURADORA_RJ_PK" ON "DEVELOPER"."SEGURADORA_RJ" ("PK_SEGURADORA")
PCTFREE 10 INITRANS 2 MAXTRANS 255
TABLESPACE "USERS" ;


-- DEVELOPER.SEGURADORA_RJ foreign keys

ALTER TABLE "DEVELOPER"."SEGURADORA_RJ" ADD CONSTRAINT "FK_MATRIZ_RJ" FOREIGN KEY ("PK_MATRIZ")
REFERENCES "DEVELOPER"."MATRIZ" ("PK_MATRIZ") ENABLE;
...
INSERT INTO DEVELOPER.SEGURADORA_PR
...
INSERT INTO DEVELOPER.SEGURADORA_SP
(PK_SEGURADORA, NM_SEGURADORA, CIDADE, ESTADO, PK_MATRIZ)
...
INSERT INTO DEVELOPER.SEGURADORA_RS
(PK_SEGURADORA, NM_SEGURADORA, CIDADE, ESTADO, PK_MATRIZ)
...
INSERT INTO DEVELOPER.SEGURADORA_RJ
(PK_SEGURADORA, NM_SEGURADORA, CIDADE, ESTADO, PK_MATRIZ)
