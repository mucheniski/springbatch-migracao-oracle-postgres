...
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(1, 'JHON SNOW', '94119479056', 1, 'MORTE POR FLECHA', 500, 1);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(1, 'JHON SNOW', '94119479056', 2, 'MORTE POR PUNHAL', 300, 3);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(1, 'JHON SNOW', '94119479056', 3, 'MORTE POR FOGO DE DRAGAO', 5000, 6);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO,  DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(1, 'JHON SNOW', '94119479056', 4, 'MORTE POR CONGELAMENTO', 1500, 7);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(2, 'JAMES HOWLETT LOGAN', '18693857053', 5, 'LESAO POR MAGNETISMO', 90, 2);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(2, 'JAMES HOWLETT LOGAN', '18693857053', 6, 'MORTE POR DECAPITACAO', 7000, 4);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(2, 'JAMES HOWLETT LOGAN', '18693857053', 7, 'MORTE POR CONTAMINACAO DE ADAMANTIUM', 55000, 5);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(2, 'JAMES HOWLETT LOGAN', '18693857053', 8, 'MORTE POR FUZILAMENTO', 3500, 8);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(3, 'LEIA SKYWALKER', '86965770007', 9, 'LESAO POR SABRE DE LUZ', 190, 1);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(3, 'LEIA SKYWALKER', '86965770007', 10, 'MORTE POR EXPLOSAO', 7000, 3);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(3, 'LEIA SKYWALKER', '86965770007', 11, 'MORTE POR QUEDA DE NAVE', 65000, 6);

INSERT INTO DEVELOPER.CORRET_SEG_PROD
(PK_CORRETOR, NM_CORRETOR, CPF_CORRETOR, COD_PRODUTO, DSC_PRODUTO, VLR_PRODUTO, PK_SEGURADORA)
VALUES(3, 'LEIA SKYWALKER', '86965770007', 12, 'MORTE POR ESTRELA DA MORTE', 350000, 8);


--  SELECT BASE ORIGEM
SELECT CORRET_SEG_PROD.PK_CORRETOR,
